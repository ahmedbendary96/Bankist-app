...
const account1 = {
  ...
  movementsDates: [
    ...
    '2020-02-01T09:15:04.904Z',
    '2020-04-01T10:17:24.185Z',
    '2020-05-08T14:11:59.604Z',
    '2022-12-14T17:01:17.194Z',
...
// Function to format movements dates
...
// Calculating and Displaying Income, Outcome, and Interest
function calcDisplaySummary(account) {
  ...
  labelSumOut.textContent = formatCur(
    ...
    account.locale,
    account.currency
  ); // NOTE: We used Math.abs() to get rid of the negative sign
